...
public class CollisionChecker {
    GamePanel gp;
    private final Map<Integer, String> elementalMap  = new HashMap<>();;
            ...
            if (entity instanceof Player) {
                if (entity.collisionOnHorizon) {
                    if (tileType1 > 0) {
                        ...
                        if (!Objects.equals(elementalMap.get(tileType1), entity.elementalState.getElementName())) {
                            gp.resetGameRequest();
                        }
                    }
                    if (tileType2 > 0) {
                        ...
                        if (!Objects.equals(elementalMap.get(tileType2), entity.elementalState.getElementName())) {
                            gp.resetGameRequest();
                        }
                    }
                    if (tileType3 > 0) {
                        ...
                        if (!Objects.equals(elementalMap.get(tileType3), entity.elementalState.getElementName())) {
                            gp.resetGameRequest();
                        }
                    }
                    if (tileType4 > 0) {
                        ...
                        if (!Objects.equals(elementalMap.get(tileType4), entity.elementalState.getElementName())) {
                            gp.resetGameRequest();
                        }
                    }
                }
            ...
            if (entity instanceof Player) {
                if (entity.collisionOnVertical) {
                    if (tileType5 > 0) {
                        ...
                        if (!Objects.equals(elementalMap.get(tileType5), entity.elementalState.getElementName())) {
                            gp.resetGameRequest();
                        }
                    }
                    if (tileType6 > 0) {
                        ...
                        if (!Objects.equals(elementalMap.get(tileType6), entity.elementalState.getElementName())) {
                            gp.resetGameRequest();
                        }
                    }
                    if (tileType7 > 0) {
                        ...
                        if (!Objects.equals(elementalMap.get(tileType7), entity.elementalState.getElementName())) {
                            gp.resetGameRequest();
                        }
                    }
                    if (tileType8 > 0) {
                        ...
                        if (!Objects.equals(elementalMap.get(tileType8), entity.elementalState.getElementName())) {
                            gp.resetGameRequest();
                        }
                    }
                }
